...
var AuthModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                ...
                jwt_1.JwtModule.registerAsync({
                    ...
                    useFactory: function (configService) { return ({
                        ...
                        signOptions: {
                            expiresIn: configService.get('JWT_EXPIRES_IN') || '7d', // Токен действует 7 дней
                        },
                    }); },
                }),
            ...
            exports: [auth_service_1.AuthService, jwt_1.JwtModule, passport_1.PassportModule], // Экспортируем для использования в других модулях
        })];
