    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.register = function (registerDto) {
            return __awaiter(this, void 0, void 0, function () {
                var existingUser, saltRounds, passwordHash, user, savedUser, _, userWithoutPassword;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            saltRounds = 10;
                            return [4 /*yield*/, bcrypt.hash(registerDto.password, saltRounds)];
                        case 2:
                        ...
                        case 3:
                            savedUser = _a.sent();
                            _ = savedUser.passwordHash, userWithoutPassword = __rest(savedUser, ["passwordHash"]);
        ...
        AuthService_1.prototype.login = function (loginDto) {
            return __awaiter(this, void 0, void 0, function () {
                var user, isPasswordValid, payload, accessToken, _, userWithoutPassword;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userRepository.findOne({
                        ...
                        case 1:
                            ...
                            if (!user.isActive) {
                                throw new common_1.UnauthorizedException('Пользователь деактивирован');
                            }
                        ...
                        case 2:
                            ...
                            payload = { sub: user.id, login: user.login, role: user.role };
        ...
        AuthService_1.prototype.updateProfile = function (userId, updateData) {
            return __awaiter(this, void 0, void 0, function () {
                var user, updatedUser, _, userWithoutPassword;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userRepository.findOne({
                                where: { id: userId },
                        ...
                        case 2:
                            updatedUser = _a.sent();
                            _ = updatedUser.passwordHash, userWithoutPassword = __rest(updatedUser, ["passwordHash"]);
                            return [2 /*return*/, userWithoutPassword];
                    }
                });
            });
